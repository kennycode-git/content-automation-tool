...
export const BUNDLES: Bundle[] = [
  ...
  },
  {
    ...
    terms: [
      ...
      'cathedral interior vaulted darkness candle singular distant',
      'storm oil painted turbulent blackened churning dramatic',
      'shadow cast wall elongated distorted baroque architectural',
      'cliff face sheer painted romantic era tempest',
      'crows etching scattered rising monochrome aged print',
      'ruins colosseum moonlit engraving crumbling desolate vast',
      'gallows woodcut medieval stark horizon bleak printed',
      'shipwreck painted dramatic rocks crashing nocturnal romanticist',
      'forest ancient gnarled silhouette tangled moonless oppressive',
      'volcanic ash painted cascading suffocating baroque dramatic',
      'iron door sealed rusted blackened subterranean hewn',
      'figure cloaked receding painted corridor candlelit baroque',
      'abyss looking downward illustrated void swallowing infinite',
    ],
  },
  {
    label: 'Gothic',
    terms: [
      ...
      'crypt descent stone steps worn torchlit subterranean',
      'rose window fractured lead light filtered coloured',
      'buttress flying arched cathedral exterior stormy dramatic',
      'bell tower silhouette lightning struck nocturnal looming',
      'choir stall carved oak worn centuries devotion',
      'transept shadowed crossing candlelit carved stone ancient',
      'abbey ruined moonlit arched windows skeletal romantic',
      'drawbridge lowered chain iron moat misted medieval',
      'portcullis iron spiked raised gateway torchlit forbidding',
      'reliquary gilded bone encased baroque ornate sacred',
      'font baptismal stone worn carved ancient ceremonial',
      'clerestory windows high narrow filtered shaft dusty',
      'rampart battlemented silhouette dusk archer positioned watchful',
    ],
  },
  {
    label: 'Surrealism',
    terms: [
      ...
      'staircase impossible ascending nowhere architectural rendered graphite',
      'shadow detached walking cobblestone dusk autonomous eerie',
      'door frame standalone barren field threshold weathered',
      'fish suspended mid-air tailored suit bowler urban',
      'mirror reflecting alternate room backwards warped uncanny',
      'mannequin fragmented torso scattered marble studio clinical',
      'moth pinned velvet specimen board obsidian Victorian',
      'root system inverted overhead ceiling tangled sprawling',
      'window opening onto ocean interior domestic flooding',
      'chess piece oversized lonely plaza concrete noon',
      'burning giraffe distant savannah amber hallucinatory painted',
      'keyhole illuminated peering darkness brass ornate locked',
      'hourglass cracked spilling feathers drifting sepia weightless',
    ],
  },
  {
